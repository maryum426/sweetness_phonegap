...
//                           TODO: return rSweets and / or userSweets?
            ...
            placesCustomerComm:function (comment, cb) {
                ...
                cSweet.set("emoticons", comment.emotion);
...
//                mText =  "Hi " + sweet.get("receiverName").split(" ")[0] + "!" + newLine + sweet.get("senderName") + " says:" + newLine + sweet.get("text") + newLine + "Respond to the Sweet gesture:"+"\n"+ constantService.getSweetAckLink() +sweet.id;
            ...
            sendCommentEmail:function (emailData, cb) {
                ...
                if (emailData.check == true){
                    ...
                    var adminEmail = emailData.owneremail;
                }else{
                    var adminEmail = '' ;
                }
                ...
                if(emailData.emoticons != ''){
                    //console.log('emoticons --:D ' + emailData.emoticons);
                    msg += newLine ;
...
//                if (emailData.emotion != ''){
//                    var emoticons = emailData.emotion.split(" ");
//                    console.log("Emoticons --> " + emoticons.length);
//                    if(emoticons.length > 0){
//                        msg += newLine ;
//                        for(var i=0; i < emoticons.length; i++){
//                            msg += newLine ;
//                            msg += "Customer ranked you: " + emoticons[i] + "!!!";
//                        }
//                    }
//                }
...
//                           var mainQuery = Parse.Query.or(query,rQuery);
            ...
            placesUsersDeleteCloud : function ( cb) {

                Parse.Cloud.run("misPlaceUserDelete",
                    {
                        //userID:userInfo
